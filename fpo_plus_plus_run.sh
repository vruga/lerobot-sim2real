...
python3 lerobot_sim2real/rl/train_fpo_plus_plus.py --env-id="PickCube-v1" --env-kwargs-json-path=env_config.json \
       --ppo.seed=${seed} \
       ...
       --ppo.fpo-per-sample-clipping --ppo.fpo-asymmetric-trust-region \
       --ppo.exp-name="fpo++-pickcube-v1-${seed}" \
